...
import uk.nhs.cdss.resourceProviders.EncounterReportProvider;

@WebServlet(urlPatterns = { "/fhir/*" }, displayName = "Reports Service")
@Configuration
@AllArgsConstructor
public class FHIRRestfulServer extends RestfulServer {
	...
	private EncounterReportProvider encounterReportProvider;
	...
	public void setResourceProviders() {
		setProviders(encounterReportProvider);
	}
